...
class EmailService {
    ...
    configure(config: EmailConfig, defaultFrom?: string) {
        this.config = config;
    ...
    // Yahoo configuration
    configureYahoo(email: string, appPassword: string) {
        this.configure({
    ...
    async configureGmailOAuth(clientId: string, clientSecret: string, refreshToken: string, userEmail: string) {
        try {
